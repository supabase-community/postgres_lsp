...
impl Rules {
    #[doc = r" Checks if the code coming from [pg_diagnostics::Diagnostic] corresponds to a rule."]
    ...
    #[doc = r" Given a category coming from [Diagnostic](pg_diagnostics::Diagnostic), this function returns"]
    #[doc = r" the [Severity](pg_diagnostics::Severity) associated to the rule, if the configuration changed it."]
...
pub struct Safety {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ban_drop_not_null: Option<RuleConfiguration<pg_analyser::options::BanDropNotNull>>,
}
impl Safety {
