...
use pg_lexer::{lex, SyntaxKind, Token, TokenType};
use pg_query_ext::{get_nodes, Node, NodeEnum, TokenProperty};

use crate::parser::Parser;

use super::syntax_builder::SyntaxBuilder;
...
pub(super) struct StatementParser<'p> {
    parser: Parser<'p>,
...
fn cmp_tokens(p: &TokenProperty, token: &Token) -> bool {
