...
pub fn resolve_type(node: &pg_query_ext::NodeEnum, schema_cache: &SchemaCache) -> PossibleType {
    match node {
        pg_query_ext::NodeEnum::AConst(n) => {
            if n.isnull {
                PossibleType::Null
            } else {
                match n
                    ...
                    .expect("expected non-nullable AConst to have a value")
                {
                    ...
                    pg_query_ext::protobuf::a_const::Val::Boolval(_) => PossibleType::AnyOf(
                        schema_cache
                            .types
                            .iter()
                    ...
                    pg_query_ext::protobuf::a_const::Val::Bsval(_) => todo!(),
                }
            }
        }
        _ => todo!(),
