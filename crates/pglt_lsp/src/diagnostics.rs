...
use anyhow::Error;
use pglt_diagnostics::print_diagnostic_to_string;
...
impl From<pglt_diagnostics::Error> for LspError {
    fn from(value: pglt_diagnostics::Error) -> Self {
        Self::Error(value)
    }
}
