...
pub fn get_completions(
    ...
    let offset = pglt_lsp_converters::from_proto::offset(
        &line_index,
...
fn to_lsp_types_completion_item_kind(
    pg_comp_kind: pglt_completions::CompletionItemKind,
) -> lsp_types::CompletionItemKind {
    match pg_comp_kind {
        pglt_completions::CompletionItemKind::Function => lsp_types::CompletionItemKind::FUNCTION,
        pglt_completions::CompletionItemKind::Table => lsp_types::CompletionItemKind::CLASS,
        pglt_completions::CompletionItemKind::Column => lsp_types::CompletionItemKind::FIELD,
    }
}
