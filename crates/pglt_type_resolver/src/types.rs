...
pub fn resolve_type(node: &pglt_query_ext::NodeEnum, schema_cache: &SchemaCache) -> PossibleType {
    match node {
        pglt_query_ext::NodeEnum::AConst(n) => {
            if n.isnull {
                PossibleType::Null
            } else {
                match n
                ...
                {
                    pglt_query_ext::protobuf::a_const::Val::Ival(_) => {
                    ...
                    pglt_query_ext::protobuf::a_const::Val::Fval(_) => {
                    ...
                    pglt_query_ext::protobuf::a_const::Val::Boolval(_) => PossibleType::AnyOf(
                        schema_cache
                            .types
                            .iter()
                    ...
                    pglt_query_ext::protobuf::a_const::Val::Sval(v) => {
                        let types: Vec<String> =
                    ...
                    pglt_query_ext::protobuf::a_const::Val::Bsval(_) => todo!(),
                }
            }
        }
        _ => todo!(),
