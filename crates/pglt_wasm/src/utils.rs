...
use pglt_console::fmt::HTML;
use pglt_console::{fmt::Formatter, markup};
use pglt_diagnostics::serde::Diagnostic;
use pglt_diagnostics::{DiagnosticExt, LineIndexBuf, PrintDiagnostic, SourceCode};
...
impl DiagnosticPrinter {
    ...
    fn print(
        ...
        printer: fn(&pglt_diagnostics::Error) -> PrintDiagnostic<pglt_diagnostics::Error>,
    ) -> Result<(), Error> {
        let diag: Diagnostic =
