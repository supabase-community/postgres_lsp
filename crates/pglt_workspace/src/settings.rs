...
impl Settings {
    ...
    pub fn as_linter_rules(&self) -> Option<Cow<pglt_configuration::analyser::linter::Rules>> {
    ...
    pub fn get_severity_from_rule_code(
        &self,
        code: &Category,
    ) -> Option<pglt_diagnostics::Severity> {
...
pub struct LinterSettings {
    ...
    /// List of rules
    pub rules: Option<pglt_configuration::analyser::linter::Rules>,
...
impl Default for LinterSettings {
    fn default() -> Self {
        Self {
            enabled: true,
            rules: Some(pglt_configuration::analyser::linter::Rules::default()),
