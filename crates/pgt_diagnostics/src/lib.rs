...
pub use pgt_console as console;

// Re-export macros from utility crates
pub use pgt_diagnostics_categories::{Category, category, category_concat};
pub use pgt_diagnostics_macros::Diagnostic;
...
pub mod prelude {
    ...
    //! intended to be imported as `use pgt_diagnostics::prelude::*;` to
