...
use crate::{statement_lexer::StatementToken, syntax_error};
...
/// can be generated.
pub fn convert_pg_query_node_to_syntax_kind(node: &NodeRef) -> SyntaxKind {
    match node {
...
/// can be generated.
pub fn convert_pg_query_token_to_syntax_kind(token: &ScanToken) -> SyntaxKind {
    match token.token {
        0 => SyntaxKind::Nul,
...
impl SyntaxKind {
    ...
    /// can be generated.
    pub fn from_statement_token(token: &StatementToken) -> Self {
        match token {
